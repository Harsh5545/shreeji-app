    ...
    <div className="bg-[#F2F0F1]">
      <div className="mx-auto max-w-screen-xl py-5 px-5 grid md:grid-cols-2">
        <div className="flex flex-col gap-8 py-12">
          <div> 
            <h2 className="text-2xl md:text-3xl text-[#EF7F1B]">SHREEJI GRAPHICS SERVICES</h2>
          ...
          <button className="bg-gradient-to-r from-[#f0a868] to-[#cf7d35] text-white p-2 rounded-[50px] w-24">Get Now</button>
        </div>
