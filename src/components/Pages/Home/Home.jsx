...
function Home() {
    ...
    usePageSeo({
        title: "ShreejiGraphics Home Page",
        description:
            "Shreeji Graphics is your online shop for custom packaging and cardboard folding boxes for small and medium runs. ",
        keywords: "ShreejiGraphics Home Page",
        ogTitle:"shreeji Home",
        ogDescription:"",
        ogImage:"",
        ogUrl:"",
    });
        ...
        <>
            ...
            <div className=" text-center flex flex-col items-center gap-5 my-12">
                ...
                <p className="w-[90%] md:w-[50%]">
                    Shreeji Graphics is your online shop for custom packaging
                    and cardboard folding boxes for small and medium runs. We
                    offer quick and easy product design for professional
                    packaging in the best quality at fair prices. Shreeji
                    Graphics provides the best custom packaging solutions to
                    help startups and established brands create the perfect
