    ...
    <>
      <TECarousel interval={4000} showIndicators crossfade ride="carousel">
        <div className="relative w-full md:h-[75vh]  overflow-hidden after:clear-both after:block after:content-['']">
          <TECarouselItem
            itemID={1}
            className="relative bg-[#E58B93]  float-left -mr-[100%] hidden h-[90%] w-full !transform-none transition-opacity duration-[600ms] ease-in-out motion-reduce:transition-none"
          >
