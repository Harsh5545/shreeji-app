...
export default function FooterComponent() {
    ...
    return (
        <footer className=" text-center  bg-neutral-600 text-neutral-200 lg:text-left">
            <div className="max-w-screen-xl mx-auto">
                <div className="flex items-center  justify-center border-b-2  p-6 border-neutral-500 lg:justify-between">
                    ...
                    <div className="flex justify-center">
                        <div className="mr-6  text-neutral-200">
                            <svg
            ...
            <div className=" py-10 max-w-screen-xl mx-auto text-center md:text-left">
            ...
            <div className="p-6 text-center bg-neutral-700">
                <div className="max-w-screen-xl text-lg gap-2 md:text-3xl flex flex-col md:flex-row mx-auto justify-around ">
                    <p>20+ Years of experience </p>
                    <span className="hidden md:flex">|</span>
                    <p>Trusted by 4000+ Businesses </p>
                    <span className="hidden md:flex">|</span>
                    <p>99% On-Time Delivery</p>
                </div>
            </div>
            <div className="w-full bg-slate-50  .roboto-medium text-black">
                <div className="flex mx-auto items-center justify-center">
                    <div className="my-auto mt-3">
                         Copyright &copy; {new Date().getFullYear()}   ShreeJi Graphics    
                    </div>
                </div>
            </div>
        </footer>
